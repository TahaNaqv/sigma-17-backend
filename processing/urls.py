...
urlpatterns = [
    ...
    path("module1/upr-impact/", views.Module1UprImpactView.as_view()),
    path("module1/jobs/", views.Module1JobListView.as_view()),
    path("module1/jobs/summary/", views.Module1SummaryJobView.as_view()),
    path("module1/preflight/", views.Module1PreflightView.as_view()),
    ...
    path("module2/jobs/sensitivity/", views.Module2SensitivityJobView.as_view()),
    path("module2/jobs/<uuid:pk>/ulr/", views.Module2JobUlrRowsView.as_view()),
    path("module2/jobs/<uuid:pk>/sensitivity/", views.Module2SensitivityResultView.as_view()),
    path("module2/jobs/<uuid:pk>/payment-pattern/", views.Module2PatternPreviewView.as_view()),
    path(
        "module2/jobs/<uuid:pk>/cashflow-projection/",
        views.Module2CashflowProjectionView.as_view(),
    ),
